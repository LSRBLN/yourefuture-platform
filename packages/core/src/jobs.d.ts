export type WorkerQueueName = 'assets' | 'checks' | 'reviews' | 'support' | 'removals' | 'retention' | 'osint';
export type WorkerJobName = 'asset.scan' | 'asset.promote' | 'check.execute' | 'osint.execute' | 'review.materialize' | 'support.triage' | 'removal.submit' | 'removal.sync_status' | 'retention.cleanup';
