...
export * from './repositories/osint-exports.repository.js';
export * from './repositories/osint-history.repository.js';
export * from './repositories/osint-results.repository.js';
export * from './repositories/osint-saved-items.repository.js';
export * from './repositories/osint-searches.repository.js';
...
export * from './repositories/user-images.repository.js';
export * from './repositories/users.repository.js';
export * from './repositories/user-sessions.repository.js';
...
export type JobEntity = {
  ...
  resourceType: 'asset' | 'check' | 'support_request' | 'removal_case' | 'osint_search';
  resourceId: string;
...
export function createTrustshieldStore(options: CreateTrustshieldStoreOptions = {}) {
  ...
  const canAccessJob = (record: JobEntity | undefined, context?: OwnershipContext) => {
    ...
    switch (record.resourceType) {
      ...
      case 'osint_search':
        return canAccessOwnedRecord(record.requestedBy, context);
      default:
        return false;
    }
  };
