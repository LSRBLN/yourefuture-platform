...
CREATE UNIQUE INDEX "user_sessions_jti_unique_idx" ON "user_sessions" USING btree ("jti");--> statement-breakpoint
CREATE UNIQUE INDEX "user_sessions_token_unique_idx" ON "user_sessions" USING btree ("token");--> statement-breakpoint
